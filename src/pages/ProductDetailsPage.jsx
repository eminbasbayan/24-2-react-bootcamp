        ...
        <div className="grid items-start grid-cols-1 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-8">
              ...
              <ul className="space-y-3 list-disc mt-4 pl-4 text-sm text-gray-200">
                <li>
            ...
            <div className="mt-8 max-w-md">
              <h3 className="text-lg font-bold text-gray-200">Reviews(10)</h3>
              <div className="space-y-3 mt-4">
                <div className="flex items-center">
                  <p className="text-sm text-gray-200 font-bold">5.0</p>
                  <svg
                  ...
                  <p className="text-sm text-gray-200 font-bold ml-3">66%</p>
                </div>
                <div className="flex items-center">
                  <p className="text-sm text-gray-200 font-bold">4.0</p>
                  <svg
                    className="w-5 fill-gray-800 ml-1"
                    viewBox="0 0 14 13"
                    fill="none"
                  ...
                  <p className="text-sm text-gray-200 font-bold ml-3">33%</p>
                </div>
                <div className="flex items-center">
                  <p className="text-sm text-gray-200 font-bold">3.0</p>
                  <svg
                    className="w-5 fill-gray-800 ml-1"
                    viewBox="0 0 14 13"
                    fill="none"
                  ...
                  <p className="text-sm text-gray-200 font-bold ml-3">16%</p>
                </div>
                <div className="flex items-center">
                  <p className="text-sm text-gray-200 font-bold">2.0</p>
                  <svg
                    className="w-5 fill-gray-800 ml-1"
                    viewBox="0 0 14 13"
                    fill="none"
                  ...
                  <p className="text-sm text-gray-200 font-bold ml-3">8%</p>
                </div>
                <div className="flex items-center">
                  <p className="text-sm text-gray-200 font-bold">1.0</p>
                  <svg
                    className="w-5 fill-gray-800 ml-1"
                    viewBox="0 0 14 13"
                    fill="none"
                  ...
                  <p className="text-sm text-gray-200 font-bold ml-3">6%</p>
                </div>
              </div>
              ...
              <button
                type="button"
                className="w-full mt-8 px-4 py-2 bg-transparent border-2 border-gray-800 text-gray-200 font-bold rounded"
              >
                Read all reviews
              </button>
            </div>
